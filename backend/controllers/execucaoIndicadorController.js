...
const fileId = process.env.GRAPH_EXCEL_FILE_ID_INDICADOR;
const tableName = 'bancoDeDadosIndicador';
...
async function salvarDadosIndicador(req, res) {
  try {
...
module.exports = { salvarDadosIndicador };